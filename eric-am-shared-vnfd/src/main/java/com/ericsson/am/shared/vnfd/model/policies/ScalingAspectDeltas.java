...
public class ScalingAspectDeltas {

    @NotBlank(message = "type is mandatory for scaling aspect deltas")
    @Pattern(regexp = "tosca.policies.nfv.VduScalingAspectDeltas")
    @JsonProperty("type")
    private String type;

    @NotNull(message = "properties can't be null for scaling aspect deltas")
    @Valid
    ...
    public void setProperties(VduScalingAspectDeltasProperties properties) {
    ...
    public boolean equals(final Object o) {
        ...
        final ScalingAspectDeltas that = (ScalingAspectDeltas) o;
        return Objects.equals(type, that.type) && Objects.equals(properties, that.properties) && Arrays.equals(targets, that.targets)
                && Objects.equals(allInitialDelta, that.allInitialDelta);
    }

    @Override
    public int hashCode() {
        int result = Objects.hash(type, properties, allInitialDelta);
